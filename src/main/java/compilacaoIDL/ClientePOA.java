 ...
 implements compilacaoIDL.ClienteOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("reiniciarRodada", new java.lang.Integer (4));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // compilacaoIDL/Cliente/reiniciarRodada
       {
         int lugar = in.read_long ();
         int quantidadePalitosRestantes = in.read_long ();
         this.reiniciarRodada (lugar, quantidadePalitosRestantes);
         out = $rh.createReply();
         break;
       }

       case 5:  // compilacaoIDL/Cliente/sairSala
       {
         int lugar = in.read_long ();
         this.sairSala (lugar);
         out = $rh.createReply();
