 ...
 implements compilacaoIDL.EventosOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("palpite", new java.lang.Integer (4));
    _methods.put ("entrarSala", new java.lang.Integer (5));
    _methods.put ("sairSala", new java.lang.Integer (6));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // compilacaoIDL/Eventos/palpite
       {
         int lugar = in.read_long ();
       ...
       case 5:  // compilacaoIDL/Eventos/entrarSala
       {
         this.entrarSala ();
         out = $rh.createReply();
         break;
       ...
       case 6:  // compilacaoIDL/Eventos/sairSala
       {
         int lugar = in.read_long ();
         this.sairSala (lugar);
         out = $rh.createReply();
