 ...
 implements compilacaoIDL.EventosOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("vencedorRodada", new java.lang.Integer (5));
    _methods.put ("empateRodada", new java.lang.Integer (6));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 5:  // compilacaoIDL/Eventos/vencedorRodada
       {
         String nome = in.read_string ();
         this.vencedorRodada (nome);
         out = $rh.createReply();
         break;
       }

       case 6:  // compilacaoIDL/Eventos/empateRodada
       {
         this.empateRodada ();
         out = $rh.createReply();
         break;
       ...
       case 7:  // compilacaoIDL/Eventos/sairSala
       {
         int lugar = in.read_long ();
         this.sairSala (lugar);
         out = $rh.createReply();
