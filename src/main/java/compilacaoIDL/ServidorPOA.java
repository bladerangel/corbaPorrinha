 ...
 implements compilacaoIDL.ServidorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("vencedor", new java.lang.Integer (11));
    _methods.put ("perdedor", new java.lang.Integer (12));
    _methods.put ("adicionarJogador", new java.lang.Integer (13));
    _methods.put ("removerJogador", new java.lang.Integer (14));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 11:  // compilacaoIDL/Servidor/vencedor
       {
         String nome = in.read_string ();
         this.vencedor (nome);
         out = $rh.createReply();
       ...
       case 12:  // compilacaoIDL/Servidor/perdedor
       {
         String nome = in.read_string ();
         this.perdedor (nome);
         out = $rh.createReply();
       ...
       case 13:  // compilacaoIDL/Servidor/adicionarJogador
       {
         String nome = in.read_string ();
       ...
       case 14:  // compilacaoIDL/Servidor/removerJogador
       {
         String nome = in.read_string ();
