 ...
 implements compilacaoIDL.ServidorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("passarTurno", new java.lang.Integer (8));
    _methods.put ("vencedor", new java.lang.Integer (9));
    _methods.put ("perdedor", new java.lang.Integer (10));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 8:  // compilacaoIDL/Servidor/passarTurno
       {
         String nome = in.read_string ();
       ...
       case 9:  // compilacaoIDL/Servidor/vencedor
       {
         String nome = in.read_string ();
         this.vencedor (nome);
         out = $rh.createReply();
       ...
       case 10:  // compilacaoIDL/Servidor/perdedor
       {
         String nome = in.read_string ();
         this.perdedor (nome);
         out = $rh.createReply();
