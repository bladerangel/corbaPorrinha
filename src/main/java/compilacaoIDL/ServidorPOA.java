 ...
 implements compilacaoIDL.ServidorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("palpitar", new java.lang.Integer (9));
    _methods.put ("vencedor", new java.lang.Integer (10));
    _methods.put ("perdedor", new java.lang.Integer (11));
    _methods.put ("adicionarJogador", new java.lang.Integer (12));
    _methods.put ("removerJogador", new java.lang.Integer (13));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 9:  // compilacaoIDL/Servidor/palpitar
       {
         int quantidadePalitosTotal = in.read_long ();
         this.palpitar (quantidadePalitosTotal);
         out = $rh.createReply();
         break;
       }

       case 10:  // compilacaoIDL/Servidor/vencedor
       {
         String nome = in.read_string ();
         this.vencedor (nome);
         out = $rh.createReply();
       ...
       case 11:  // compilacaoIDL/Servidor/perdedor
       {
         String nome = in.read_string ();
         this.perdedor (nome);
         out = $rh.createReply();
       ...
       case 12:  // compilacaoIDL/Servidor/adicionarJogador
       {
         String nome = in.read_string ();
       ...
       case 13:  // compilacaoIDL/Servidor/removerJogador
       {
         String nome = in.read_string ();
